...
<FlexiblePlanCard/>
            ...
            <Button w="150px" backgroundColor="#3167ff" color="white" h="45px" borderRadius="none" textAlign="center" _hover={{boxShadow:"rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px"}}>Sign Up Now</Button>
